...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.meibrfewgfqgfdg4.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 50696;
pub const RELAY_PORT: i32 = 50697;
pub const WS_RENDEZVOUS_PORT: i32 =50698;
pub const WS_RELAY_PORT: i32 = 50699;
