...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("协云通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.piug43wfegfdsy4q3fgd7.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 57106;
pub const RELAY_PORT: i32 = 57107;
pub const WS_RENDEZVOUS_PORT: i32 =57108;
pub const WS_RELAY_PORT: i32 = 57109;
