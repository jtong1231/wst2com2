...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("亿舒云".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.cdnwjsn1jf2.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 45906;
pub const RELAY_PORT: i32 = 45907;
pub const WS_RENDEZVOUS_PORT: i32 =45908;
pub const WS_RELAY_PORT: i32 = 45909;
