...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.weil2k3j4jkf5.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 53806;
pub const RELAY_PORT: i32 = 53807;
pub const WS_RENDEZVOUS_PORT: i32 =53808;
pub const WS_RELAY_PORT: i32 = 53809;
