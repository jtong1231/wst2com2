...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.biugmwkjjktj13.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 49806;
pub const RELAY_PORT: i32 = 49807;
pub const WS_RENDEZVOUS_PORT: i32 =49808;
pub const WS_RELAY_PORT: i32 = 49809;
