...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("贝声通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.biugn43hjdsd10.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 49506;
pub const RELAY_PORT: i32 = 49507;
pub const WS_RENDEZVOUS_PORT: i32 =49508;
pub const WS_RELAY_PORT: i32 = 49509;
