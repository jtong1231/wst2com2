...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("合连通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.gandfnu3fds6.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 47006;
pub const RELAY_PORT: i32 = 47007;
pub const WS_RENDEZVOUS_PORT: i32 =47008;
pub const WS_RELAY_PORT: i32 = 47009;
