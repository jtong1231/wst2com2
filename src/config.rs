...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.weifmgf32s6.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 53906;
pub const RELAY_PORT: i32 = 53907;
pub const WS_RENDEZVOUS_PORT: i32 =53908;
pub const WS_RELAY_PORT: i32 = 53909;
