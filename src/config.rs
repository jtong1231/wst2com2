...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("升亿通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.nxkansa5.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 45406;
pub const RELAY_PORT: i32 = 45407;
pub const WS_RENDEZVOUS_PORT: i32 =45408;
pub const WS_RELAY_PORT: i32 = 45409;
