...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("仁视通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.jiuffh32ukjsdfg4m2lqds1.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 51896;
pub const RELAY_PORT: i32 = 51897;
pub const WS_RENDEZVOUS_PORT: i32 =51898;
pub const WS_RELAY_PORT: i32 = 51899;
