...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("山看云".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.biunfjdbw3jfd14.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 49906;
pub const RELAY_PORT: i32 = 49907;
pub const WS_RENDEZVOUS_PORT: i32 =49908;
pub const WS_RELAY_PORT: i32 = 49909;
