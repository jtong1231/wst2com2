...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.huig43rfdgerg9.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 55206;
pub const RELAY_PORT: i32 = 55207;
pub const WS_RENDEZVOUS_PORT: i32 =55208;
pub const WS_RELAY_PORT: i32 = 55209;
