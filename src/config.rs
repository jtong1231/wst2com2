...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.biuvnhewh3j7.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 49206;
pub const RELAY_PORT: i32 = 49207;
pub const WS_RENDEZVOUS_PORT: i32 =49208;
pub const WS_RELAY_PORT: i32 = 49209;
