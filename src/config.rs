...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.meighqfdgrgfa4w8.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 51096;
pub const RELAY_PORT: i32 = 51097;
pub const WS_RENDEZVOUS_PORT: i32 =51098;
pub const WS_RELAY_PORT: i32 = 51099;
