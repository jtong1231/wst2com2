...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.jfwsd83fsd.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 44806;
pub const RELAY_PORT: i32 = 44807;
pub const WS_RENDEZVOUS_PORT: i32 =44808;
pub const WS_RELAY_PORT: i32 = 44809;
