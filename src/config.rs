...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.jiugfdsgdfhgsr12.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 52996;
pub const RELAY_PORT: i32 = 52997;
pub const WS_RENDEZVOUS_PORT: i32 =52998;
pub const WS_RELAY_PORT: i32 = 52999;
