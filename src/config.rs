...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.jiugfdsgfg7.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 52496;
pub const RELAY_PORT: i32 = 52497;
pub const WS_RENDEZVOUS_PORT: i32 =52498;
pub const WS_RELAY_PORT: i32 = 52499;
