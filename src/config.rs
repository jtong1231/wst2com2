...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.jiugfdg4fdf6.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 52396;
pub const RELAY_PORT: i32 = 52397;
pub const WS_RENDEZVOUS_PORT: i32 =52398;
pub const WS_RELAY_PORT: i32 = 52399;
