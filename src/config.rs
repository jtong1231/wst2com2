...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.piuf42efdf43f2.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 56606;
pub const RELAY_PORT: i32 = 56607;
pub const WS_RENDEZVOUS_PORT: i32 =56608;
pub const WS_RELAY_PORT: i32 = 56609;
