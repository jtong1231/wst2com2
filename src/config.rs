...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.beifbu32hdjsd8.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 56106;
pub const RELAY_PORT: i32 = 56107;
pub const WS_RENDEZVOUS_PORT: i32 =56108;
pub const WS_RELAY_PORT: i32 = 56109;
