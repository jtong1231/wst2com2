...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.jfwsd73fsd.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 44706;
pub const RELAY_PORT: i32 = 44707;
pub const WS_RENDEZVOUS_PORT: i32 =44708;
pub const WS_RELAY_PORT: i32 = 44709;
