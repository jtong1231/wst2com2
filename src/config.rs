...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.yinfdg342fgdghr12.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 55796;
pub const RELAY_PORT: i32 = 55797;
pub const WS_RENDEZVOUS_PORT: i32 =55798;
pub const WS_RELAY_PORT: i32 = 55799;
