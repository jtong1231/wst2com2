...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.meighrqrdgdg5.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 50796;
pub const RELAY_PORT: i32 = 50797;
pub const WS_RENDEZVOUS_PORT: i32 =50798;
pub const WS_RELAY_PORT: i32 = 50799;
