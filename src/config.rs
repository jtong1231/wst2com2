...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.guo3bhbshf3.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 47706;
pub const RELAY_PORT: i32 = 47707;
pub const WS_RENDEZVOUS_PORT: i32 =47708;
pub const WS_RELAY_PORT: i32 = 47709;
