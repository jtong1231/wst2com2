...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd6.ganajnb2ucn7.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 47106;
pub const RELAY_PORT: i32 = 47107;
pub const WS_RENDEZVOUS_PORT: i32 =47108;
pub const WS_RELAY_PORT: i32 = 47109;
