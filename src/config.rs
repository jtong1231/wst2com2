...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.fuoahegajs1.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 57806;
pub const RELAY_PORT: i32 = 57807;
pub const WS_RENDEZVOUS_PORT: i32 =57808;
pub const WS_RELAY_PORT: i32 = 57809;
