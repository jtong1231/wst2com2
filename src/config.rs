...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("间节通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.beidh3u2idhsdfh6.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 55906;
pub const RELAY_PORT: i32 = 55907;
pub const WS_RENDEZVOUS_PORT: i32 =55908;
pub const WS_RELAY_PORT: i32 = 55909;
