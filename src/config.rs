...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("语练通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.biumwkjerkewewf12.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 49706;
pub const RELAY_PORT: i32 = 49707;
pub const WS_RENDEZVOUS_PORT: i32 =49708;
pub const WS_RELAY_PORT: i32 = 49709;
