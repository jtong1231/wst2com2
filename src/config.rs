...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("快通芸".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cdn.fnkewkknfksm.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 40096;
pub const RELAY_PORT: i32 = 40097;
pub const WS_RENDEZVOUS_PORT: i32 =40098;
pub const WS_RELAY_PORT: i32 = 40099;
