...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.yindgwfdg4a5.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 55096;
pub const RELAY_PORT: i32 = 55097;
pub const WS_RENDEZVOUS_PORT: i32 =55098;
pub const WS_RELAY_PORT: i32 = 55099;
