...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.jiuregrfegf10.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 52796;
pub const RELAY_PORT: i32 = 52797;
pub const WS_RENDEZVOUS_PORT: i32 =52798;
pub const WS_RELAY_PORT: i32 = 52799;
