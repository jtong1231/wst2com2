...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.guoncjdsbj11.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 48506;
pub const RELAY_PORT: i32 = 48507;
pub const WS_RENDEZVOUS_PORT: i32 =48508;
pub const WS_RELAY_PORT: i32 = 48509;
