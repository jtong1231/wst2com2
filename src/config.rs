...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.jfwsd43fsd.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 44406;
pub const RELAY_PORT: i32 = 44407;
pub const WS_RENDEZVOUS_PORT: i32 =44408;
pub const WS_RELAY_PORT: i32 = 44409;
