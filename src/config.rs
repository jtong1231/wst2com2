...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.jiugfdsghfdshgfhtr14.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 53196;
pub const RELAY_PORT: i32 = 53197;
pub const WS_RENDEZVOUS_PORT: i32 =53198;
pub const WS_RELAY_PORT: i32 = 53199;
