...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.banfegweffdsdf13.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 54496;
pub const RELAY_PORT: i32 = 54497;
pub const WS_RENDEZVOUS_PORT: i32 =54498;
pub const WS_RELAY_PORT: i32 = 54499;
