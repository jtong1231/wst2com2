...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.fuofewrji3k2.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 57906;
pub const RELAY_PORT: i32 = 57907;
pub const WS_RENDEZVOUS_PORT: i32 =57908;
pub const WS_RELAY_PORT: i32 = 57909;
