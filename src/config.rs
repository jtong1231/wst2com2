...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.banvfe2fdsgfwafd3.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 53596;
pub const RELAY_PORT: i32 = 53597;
pub const WS_RENDEZVOUS_PORT: i32 =53598;
pub const WS_RELAY_PORT: i32 = 53599;
