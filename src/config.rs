...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.cdn2eslfs4.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 46106;
pub const RELAY_PORT: i32 = 46107;
pub const WS_RENDEZVOUS_PORT: i32 =46108;
pub const WS_RELAY_PORT: i32 = 46109;
