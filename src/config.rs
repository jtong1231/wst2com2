...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("和连云".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.ganjcnjqdsf4.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 46806;
pub const RELAY_PORT: i32 = 46807;
pub const WS_RENDEZVOUS_PORT: i32 =46808;
pub const WS_RELAY_PORT: i32 = 46809;
