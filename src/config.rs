...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd1.huig34rfdsg4.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 54706;
pub const RELAY_PORT: i32 = 54707;
pub const WS_RENDEZVOUS_PORT: i32 =54708;
pub const WS_RELAY_PORT: i32 = 54709;
