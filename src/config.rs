...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.huibt45wf6.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 54906;
pub const RELAY_PORT: i32 = 54907;
pub const WS_RENDEZVOUS_PORT: i32 =54908;
pub const WS_RELAY_PORT: i32 = 54909;
