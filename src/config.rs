...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.meig3qdfgghfdsgh12.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 51496;
pub const RELAY_PORT: i32 = 51497;
pub const WS_RENDEZVOUS_PORT: i32 =51498;
pub const WS_RELAY_PORT: i32 = 51499;
