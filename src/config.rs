...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("T".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.bangdfgwefdsvgdrsfrwqd4.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 53696;
pub const RELAY_PORT: i32 = 53697;
pub const WS_RENDEZVOUS_PORT: i32 =53698;
pub const WS_RELAY_PORT: i32 = 53699;
