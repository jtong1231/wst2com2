...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("欢众云".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.beifh32idhsjfh10.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 56306;
pub const RELAY_PORT: i32 = 56307;
pub const WS_RENDEZVOUS_PORT: i32 =56308;
pub const WS_RELAY_PORT: i32 = 56309;
