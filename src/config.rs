...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.guocbsdf7.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 48106;
pub const RELAY_PORT: i32 = 48107;
pub const WS_RENDEZVOUS_PORT: i32 =48108;
pub const WS_RELAY_PORT: i32 = 48109;
