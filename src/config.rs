...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("此刻通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.guo2bfdsjf10.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 48406;
pub const RELAY_PORT: i32 = 48407;
pub const WS_RENDEZVOUS_PORT: i32 =48408;
pub const WS_RELAY_PORT: i32 = 48409;
