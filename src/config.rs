...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.guofbewyu8.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 48206;
pub const RELAY_PORT: i32 = 48207;
pub const WS_RENDEZVOUS_PORT: i32 =48208;
pub const WS_RELAY_PORT: i32 = 48209;
