...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.jiu43tgr3wgfdg9.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 52696;
pub const RELAY_PORT: i32 = 52697;
pub const WS_RENDEZVOUS_PORT: i32 =52698;
pub const WS_RELAY_PORT: i32 = 52699;
