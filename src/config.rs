...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.ganncdsd1.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 46506;
pub const RELAY_PORT: i32 = 46507;
pub const WS_RENDEZVOUS_PORT: i32 =46508;
pub const WS_RELAY_PORT: i32 = 46509;
