...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("畅慧议".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.piufb4u2hjadfjsghafjs12.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 57606;
pub const RELAY_PORT: i32 = 57607;
pub const WS_RENDEZVOUS_PORT: i32 =57608;
pub const WS_RELAY_PORT: i32 = 57609;
...
impl UserDefaultConfig {
    ...
    pub fn get(&self, key: &str) -> String {
        match key {
            ...
            keys::OPTION_CODEC_PREFERENCE => {
                self.get_string(key, "vp8", vec!["vp8", "vp9", "av1", "h264", "h265"])
            }
