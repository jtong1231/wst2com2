...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd2.huif42ewgfdgf7.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 55006;
pub const RELAY_PORT: i32 = 55007;
pub const WS_RENDEZVOUS_PORT: i32 =55008;
pub const WS_RELAY_PORT: i32 = 55009;
